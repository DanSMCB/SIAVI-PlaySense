...
namespace Mediapipe.Unity.Sample.HandLandmarkDetection.UI
{
    public class HandLandmarkDetectionConfigWindow : ModalContents
    {
        ...
        private void SwitchDelegate()
        {
            ...
            HandLandmarkRuntimeSettings.Delegate = _config.Delegate;
            _isChanged = true;
        }
        ...
        private void SwitchImageReadMode()
        {
            ...
            HandLandmarkRuntimeSettings.ImageReadMode = _config.ImageReadMode;
            _isChanged = true;
        }
        ...
        private void SwitchRunningMode()
        {
            ...
            HandLandmarkRuntimeSettings.RunningMode = _config.RunningMode;
            _isChanged = true;
        }
        ...
        private void SetNumHands()
        {
            if (int.TryParse(_numHandsInput.text, out var value))
            {
                ...
                HandLandmarkRuntimeSettings.NumHands = value;
                _isChanged = true;
            }
        }
        ...
        private void SetMinHandDetectionConfidence()
        {
            if (float.TryParse(_minHandDetectionConfidenceInput.text, out var value))
            {
                ...
                HandLandmarkRuntimeSettings.MinHandDetectionConfidence = value;
                _isChanged = true;
            }
        }
        ...
        private void SetMinHandPresenceConfidence()
        {
            if (float.TryParse(_minHandPresenceConfidenceInput.text, out var value))
            {
                ...
                HandLandmarkRuntimeSettings.MinHandPresenceConfidence = value;
                _isChanged = true;
            }
        }
        ...
        private void SetMinTrackingConfidence()
        {
            if (float.TryParse(_minTrackingConfidenceInput.text, out var value))
            {
                ...
                HandLandmarkRuntimeSettings.MinTrackingConfidence = value;
                _isChanged = true;
            }
        }
        ...
        {
            // Load saved values into runtime settings first
            _config.Delegate = HandLandmarkRuntimeSettings.Delegate;
            _config.ImageReadMode = HandLandmarkRuntimeSettings.ImageReadMode;
            _config.RunningMode = HandLandmarkRuntimeSettings.RunningMode;
            _config.NumHands = HandLandmarkRuntimeSettings.NumHands;
            _config.MinHandDetectionConfidence = HandLandmarkRuntimeSettings.MinHandDetectionConfidence;
            _config.MinHandPresenceConfidence = HandLandmarkRuntimeSettings.MinHandPresenceConfidence;
            _config.MinTrackingConfidence = HandLandmarkRuntimeSettings.MinTrackingConfidence;
